      ...
      <main>
        ...
        <section className="py-20 bg-white dark:bg-sop-bg">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 text-[#6B7280] leading-8 dark:text-sop-muted">
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Overview</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Information We Collect</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>How We Use Your Data</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Sharing and Retention</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Your Rights</h2>

  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="py-20 bg-white dark:bg-sop-bg">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 text-[#6B7280] leading-8 dark:text-sop-muted">
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Scope of Services</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Intellectual Property</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Payment and Cancellation</h2>
            ...
            <section>
              <h2 className="text-3xl text-[#1A1A2E] font-bold dark:text-sop-foreground" style={{ fontFamily: 'var(--font-heading)' }}>Limitation of Liability</h2>

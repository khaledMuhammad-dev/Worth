...
export default function NotFound() {
  ...
  return (
    <>
      <Navbar />
      <main className="bg-white dark:bg-sop-bg">
        <section className="py-24 md:py-32">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="heading-l text-[#1A1A2E] dark:text-sop-foreground">{t('notFound.title')}</h1>
            <p className="mt-4 text-lg text-[#6B7280] max-w-2xl mx-auto dark:text-sop-muted">{t('notFound.subtitle')}</p>
